          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-0">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              <Button 
                ...
                variant="outline"
                className="border-primary/20 hover:border-primary/50 text-xs sm:text-sm px-3 sm:px-4"
              >
                Espace Client
              </Button>
              <Button 
                onClick={() => setIsPopupOpen(true)}
                className="bg-gradient-to-r from-primary to-accent hover:shadow-[0_0_30px_rgba(124,58,237,0.5)] transition-all duration-300 text-xs sm:text-sm px-3 sm:px-4"
              >
                Contact
              </Button>
            </div>
